                ...
                <div id="carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item <?php $c++; if($c ==1){echo 'active';}?>">
                             <?php the_post_thumbnail('banner', array('class'=> 'img-fluid rounded')); ?>
                            <div class="carousel-caption -titulo">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="mb-4  title-my-color-1">
                          <?php 
                          //Função para limitar o tamanho do texto exibido
                          echo mb_strimwidth(get_the_title(), 0, 65, '...'); 
                          ?>
                        </h5>
                        <a href="<?php the_permalink(); ?>" class="btn btn-outline-my-color-1 text-uppercase">Leia Mais</a>
                    </div>
                </div>
            </div>
         <?php endwhile; endif; ?>
