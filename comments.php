...
<?php if( have_comments() && comments_open() ) : ?>
  ...
  <?php $comments_arg = array(
    ...
    'class_submit' => 'btn btn-outline-my-color-1 text-uppercase',
    ...
    'fields' => apply_filters(  'comment_form_default_fields', array(
        ...
        'email' => '<div class="col-md-6 col-sm-12"> <div class="form-group">' . 
          ...
          'comment_field' => ' <p>' .
                                          '<textarea id="comment" class="form-control" placeholder="Sua mensagem..." name="comment" row="3" aria-required="true"></textarea>' . '</p>' ,
         'comment_notes_after'=> ' ', 
    );
